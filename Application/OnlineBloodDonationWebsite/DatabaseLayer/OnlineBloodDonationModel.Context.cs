...
namespace DatabaseLayer
{
    ...
    public partial class OnlineBloodDonation_DbEntities : DbContext
    {
        public OnlineBloodDonation_DbEntities()
            : base("name=OnlineBloodDonation_DbEntities")
        {
        }
        ...
        public virtual DbSet<BloodStockDetailTable> BloodStockDetailTables { get; set; }
